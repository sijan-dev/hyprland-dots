...
#General
alias ls='eza  --icons=auto  --no-symlinks  --classify=never'
alias l='eza -lh --icons=auto --classify=never'
alias zed='zeditor'
abbr -a c clear
abbr -a la 'ls -a'
...
abbr -a yayf "paru -Slq | fzf --multi --preview 'paru -Sii {1}' --preview-window=down:75% | xargs -ro paru -S"
...
abbr -a nb 'nvim ~/.config/hypr/bindings.lua'
